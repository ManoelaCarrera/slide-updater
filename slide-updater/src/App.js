...
function AppContent() {
    ...
    return (<div className="flex flex-col h-screen bg-neutral-50">
      <Navbar />
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col">
          <div className="border-b border-neutral-200 bg-white px-4 py-3 flex gap-2 justify-between">
            ...
            <Button variant="ghost" size="sm" onClick={() => setShowSettings(true)} aria-label="Abrir configurações">
              ⚙️
            </Button>
          </div>

          {showSettings ? (<SettingsPanel />) : showExport ? (<ExportPanel />) : (<SlideEditor />)}
        </div>
      </div>
