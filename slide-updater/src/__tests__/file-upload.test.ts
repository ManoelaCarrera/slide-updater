...
export const fileUploadTests: FileUploadTestCase[] = [
  {
...
Métodos de prevenção com fotobiomodulação`,
  ...
  },
  {
    ...
    expectedResult:
      'Error message: "Erro ao processar PPTX. Certifique-se de que a dependência docx está instalada."',
    severity: 'high',
  },
  {
