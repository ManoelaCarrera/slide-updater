...
export async function searchScopus(keywords, apiKey) {
 ...
 */
export function getScopusApiKey() {
    try {
 ...
 */
export function setScopusApiKey(apiKey) {
    try {
        const settings = localStorage.getItem('app-settings') || '{}';
        const parsed = JSON.parse(settings);
 ...
 */
export function clearScopusApiKey() {
    try {
        const settings = localStorage.getItem('app-settings') || '{}';
        const parsed = JSON.parse(settings);
