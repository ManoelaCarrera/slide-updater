    ...
    <div className="flex flex-col gap-3 border border-neutral-200 rounded-lg overflow-hidden bg-white">
      ...
      <div className="bg-neutral-50 border-b border-neutral-200 p-3 flex flex-wrap gap-1 items-center">
        ...
        <select
          ...
          className="px-2 py-1 text-sm border border-neutral-200 rounded bg-white hover:bg-neutral-100 cursor-pointer"
          aria-label="Selecionar nível de título"
          disabled={disabled}
        >
      ...
      <div
        ...
        className="flex-1 p-3 min-h-64 outline-none focus:ring-2 focus:ring-primary-600 prose prose-sm max-w-none
          [&]:text-neutral-900 [&_p]:mb-2 [&_ul]:ml-4 [&_ol]:ml-4 [&_blockquote]:border-l-4 [&_blockquote]:border-primary-600
          [&_blockquote]:bg-neutral-50 [&_blockquote]:pl-3 [&_code]:bg-neutral-100 [&_code]:px-1 [&_code]:rounded"
