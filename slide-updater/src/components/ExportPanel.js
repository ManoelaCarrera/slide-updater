    ...
    return (<div className="p-4 space-y-4">
      <Card>
        ...
        <CardBody className="space-y-3">
          <Button variant="primary" onClick={exportToHTML} isLoading={isExporting} className="w-full" aria-label="Exportar apresentação como arquivo HTML">
            📄 Exportar como HTML
          </Button>
          <Button variant="primary" onClick={exportToPPTX} isLoading={isExporting} className="w-full" aria-label="Exportar apresentação como arquivo PowerPoint PPTX">
            📊 Exportar como PPTX
          </Button>
          <Button variant="secondary" onClick={exportToJSON} isLoading={isExporting} className="w-full" aria-label="Fazer backup dos dados da apresentação em formato JSON">
            💾 Backup JSON
          </Button>
        </CardBody>
      </Card>
